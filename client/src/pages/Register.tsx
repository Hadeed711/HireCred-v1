      ...
      <div className="hidden lg:flex lg:w-5/12 bg-linear-to-br from-indigo-950 via-indigo-900 to-violet-900 flex-col justify-between p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <div className="animate-fade-up stagger-1">
            <h2 className="text-3xl font-bold leading-snug mb-3 tracking-tight">
              Your credibility,<br />
          ...
          <div className="animate-fade-up stagger-2">
            ...
            <div className="space-y-4">
              {STEPS.map((step, i) => (
                <div key={i} className={`flex items-center gap-3.5 animate-fade-up stagger-${i + 3}`}>
          ...
          {/* Stat callout */}
          <div className="bg-white/10 rounded-2xl p-4 border border-white/10 backdrop-blur-sm animate-fade-up stagger-6">
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-indigo-100/50 border border-gray-200/80 p-8 animate-scale-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-linear-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 disabled:opacity-50 text-white font-semibold py-2.5 px-4 rounded-xl text-sm shadow-md shadow-indigo-300/50 hover:shadow-lg hover:shadow-indigo-300/60 mt-1 transition-all duration-200"
              >
                {loading ? (
